...
super(nama, noKTP); this.penjualan = penjualan; this.komisi = komisi;
}

public int getPenjualan() { return penjualan;
}
...
System.out.printf("%-20s: %s%n","Sales", getNama()); print += String.format("%-20s: %d%n", "Total Penjualan", getPenjualan());
